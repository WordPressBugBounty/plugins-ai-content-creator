...
function aicc_idiomas_traducidos() {
	$languages = array(
		...
		'sk'  => __( 'Slovak', 'ai-content-creator' ),
 ...
 *
 * @param array $matriz_origen Matriz asociativa a invertir.
 * @return array Matriz asociativa invertida.
 */
function aicc_intercambiar_claves_por_valores( $matriz_origen ) {
	$nuevo_array = array();
	foreach ( $matriz_origen as $clave => $valor ) {
