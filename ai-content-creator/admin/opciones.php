...
function aicc_settings_modelo_callback() {
	...
	$texto = '<b>' . __( 'Old, not recommended', 'ai-content-creator' ) . '</b>. ' . __( 'Legacy GPT model for cheaper chat and non-chat tasks', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-3.5-turbo', $texto );

	/* translators: %s: Factor multiplicador del precio, por ejemplo "30x". */
	$texto = __( 'GPT-4', 'ai-content-creator' ) . ' ' . __( 'An older high-intelligence GPT model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-4', $texto );

	$texto = __( 'GPT-4 turbo', 'ai-content-creator' ) . ' ' . __( 'An older high-intelligence GPT model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-4-turbo', $texto );

	$texto = '<b>' . __( 'Recommended', 'ai-content-creator' ) . '</b>. ' . __( 'Fast, intelligent, flexible GPT model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-4o', $texto );

	$texto = '<b>' . __( 'The cheaper', 'ai-content-creator' ) . '</b>. ' . __( 'Fast, affordable small model for focused tasks', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-4o-mini', $texto );

	$texto = __( 'GPT-4.5', 'ai-content-creator' ) . ' ' . __( 'Largest GPT-4.5 model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'gpt-4.5', $texto );

	$texto = __( 'o1', 'ai-content-creator' ) . ' ' . __( 'High-intelligence reasoning model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'o1', $texto );

	$texto = __( 'o1 pro', 'ai-content-creator' ) . ' ' . __( 'A version of o1 with more compute for better responses', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'o1-pro', $texto );

	$texto = __( 'o1 mini', 'ai-content-creator' ) . ' ' . __( 'A faster, more affordable reasoning model than o1', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'o1-mini', $texto );

	$texto = __( 'o3 mini', 'ai-content-creator' ) . ' ' . __( 'Fast, flexible, intelligent reasoning model', 'ai-content-creator' );
	aicc_mostrar_campo_radio_modelo( $modelo, 'o3-mini', $texto );
}
