...
class AIccGeneracion {
	...
	*/
	...
	private function precio_token_solicitud() {
		switch ( $this->modelo() ) {
			case 'o3-mini':
				$precio_token = 1.1 / 1000000;
				break;
			case 'o1-mini':
				$precio_token = 1.1 / 1000000;
				break;
			case 'o1':
				$precio_token = 15 / 1000000;
				break;
			case 'o1-pro':
				$precio_token = 150 / 1000000;
				break;
			case 'gpt-4.5':
				$precio_token = 75 / 1000000;
				break;
			case 'gpt-4o-mini':
				$precio_token = 0.15 / 1000000;
				break;
			case 'gpt-4o':
				$precio_token = 2.5 / 1000000;
				break;
			case 'gpt-4-turbo':
				$precio_token = 10 / 1000000;
				break;
			case 'gpt-4':
				$precio_token = 30 / 1000000;
				break;
			case 'gpt-3.5-turbo':
				$precio_token = 0.5 / 1000000;
				break;
			default:
				$precio_token = 0;
				break;
	...
	private function precio_token_respuesta() {
		switch ( $this->modelo() ) {
			case 'o3-mini':
				$precio_token = 4.4 / 1000000;
				break;
			case 'o1-mini':
				$precio_token = 4.4 / 1000000;
				break;
			case 'o1':
				$precio_token = 60 / 1000000;
				break;
			case 'o1-pro':
				$precio_token = 600 / 1000000;
				break;
			case 'gpt-4.5':
				$precio_token = 150 / 1000000;
				break;
			case 'gpt-4o-mini':
				$precio_token = 0.6 / 1000000;
				break;
			case 'gpt-4o':
				$precio_token = 10 / 1000000;
				break;
	...
	public function bloque_operaciones_html() {
		...
		// Se pueden ver en https://developer.wordpress.org/resource/dashicons/ .

		return $html;
	}

	/**
	 * Define los elementos HTML permitidos para las operaciones del artículo.
	 *
	 * Esta función devuelve un array que especifica las etiquetas y atributos HTML
	 * que están permitidos al usar `wp_kses()` para escapar el contenido generado
	 * por funciones como `bloque_operaciones_html()`. Esto garantiza que solo se
	 * permita contenido HTML seguro y evita la inyección de código malicioso (XSS).
	 *
	 * @since 1.0.0
	 *
	 * @return array Un array asociativo que define las etiquetas HTML permitidas y sus atributos.
	 *              Cada clave del array es una etiqueta HTML (por ejemplo, 'div', 'p', 'form', 'input'),
	 *              y su valor es un array de atributos permitidos para esa etiqueta.
	 */
	public function aicc_permitidos_kses_operaciones() {
		return array(
			'div'    => array(
				'id'    => array(),
				'style' => array(),
